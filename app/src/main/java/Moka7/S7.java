...
public class S7 {
    ...
    public static final int S7AreaPE = 0x81; //Process Inputs
    public static final int S7AreaPA = 0x82; //Process Outputs
    public static final int S7AreaMK = 0x83; //Memento
    public static final int S7AreaDB = 0x84; //DataBase
    public static final int S7AreaCT = 0x1C; //Counters
    public static final int S7AreaTM = 0x1D; //Timers
    // Connection types
